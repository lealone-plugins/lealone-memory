 ...
 */
package org.lealone.plugins.memory.test;

import org.junit.Test;
import org.lealone.db.PluginManager;
import org.lealone.plugins.memory.MemoryStorageEngine;
...
public class MemoryStorageEngineTest extends TestBase {

    @Test
    public void run() {
        Storage storage = getStorage(MemoryStorageEngine.NAME);
        testMap(storage);
    ...
    private static Storage getStorage(String name) {
        ...
        builder.storagePath(joinDirs(name));
